startReactor = {
    ...
    audio: {
        ...
        loadAudios() {
            ...
            startReactor.audio.combinations = startReactor.audio.combinations
                .map((audio) => startReactor.audio.loadAudio(audio))
        }
    },
    ...
    createCombination() {
        let newCombination = []
        for (var n = 0; n < startReactor.combinationMaxPosition; n++) {
    ...
    play(index) {
        ...
        if(startReactor.isTheRightCombination(startReactor.playerCombination.length)) {
            ...
            if(startReactor.playerCombination.length == startReactor.combinationMaxPosition) {
                ...
                setTimeout(() => startReactor.start(), 1200);
                return
            }
            ...
            if(startReactor.playerCombination.length == startReactor.computerCombinationPosition) {
                ...
                setTimeout(() => startReactor.playCombination(), 1200);
            }
        } else {
